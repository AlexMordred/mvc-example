...
class DB
{
    ...
    {
        // if (!$this->pdo->query("SHOW TABLES LIKE 'questions'")->rowCount()) {
        //     $this->pdo->exec('
        ...
        // if (!$this->pdo->query("SHOW TABLES LIKE 'results'")->rowCount()) {
        //     $this->pdo->exec('
        //         CREATE TABLE results (
        //             id INT(11) AUTO_INCREMENT PRIMARY KEY,
        //             user_intelligence TINYINT UNSIGNED,
        //             question_difficulty_from TINYINT UNSIGNED,
        //             question_difficulty_to TINYINT UNSIGNED,
